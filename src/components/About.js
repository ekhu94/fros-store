        ...
        <div className="px-0">
            ...
            <Container>
                ...
                <div id="pars" className="mx-3 mx-md-4 mx-lg-5 text-left">
                    <p className="mt-3 mt-md-4 mt-lg-5">For Real Ominous Souls is a fashion brand located on the West Coast. Founded in 2020, FROS specializes in manufacturing black clothing and outfits. We believe there is great artistry in subdued simplicity, and strive to reflect that in all our product lines.</p>
                    <p className="mt-3 mt-md-4 mt-lg-5">Our 2021 BlɅck Soul line was inspired by the countless struggles and endeavours of people around the world during this turbulent time. Be sure to check out our new award-winning Winter Collection consisting of brand new outerwear and bottoms for any weather or occasion.</p>
